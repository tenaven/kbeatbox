...
import net.deeppay.kmicrostreams.kbeatbox.api.Condition

/**
  * State interface to support storing and accessing the index.
  */
trait IndexOptimizedLiftedTaskStateInterface extends LiftedTaskStateInterface {
