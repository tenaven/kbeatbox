...
import net.deeppay.kmicrostreams.kbeatbox.finitestatemachine.HeartBeatKeepingFiniteStateMachine
import net.deeppay.kmicrostreams.kbeatbox.stateapi.HeartBeatKeepingStateInterface

import scala.collection.immutable.TreeMap

class MockConcreteHeartBeatKeepingFiniteStateMachine extends HeartBeatKeepingFiniteStateMachine {

  override def zero() : HeartBeatKeepingStateInterface = new HeartBeatKeepingMockState(None,
    ackIndex = Map.empty,
