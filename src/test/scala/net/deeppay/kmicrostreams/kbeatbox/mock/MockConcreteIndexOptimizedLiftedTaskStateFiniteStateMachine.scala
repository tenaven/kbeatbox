...
import net.deeppay.kmicrostreams.kbeatbox.finitestatemachine.IndexOptimizedLiftedTaskStateFiniteStateMachine
import net.deeppay.kmicrostreams.kbeatbox.stateapi.IndexOptimizedLiftedTaskStateInterface

import scala.collection.immutable.TreeMap

class MockConcreteIndexOptimizedLiftedTaskStateFiniteStateMachine extends IndexOptimizedLiftedTaskStateFiniteStateMachine[IndexOptimizedLiftedTaskStateInterface] {
  override def zero(): IndexOptimizedLiftedTaskStateInterface = {
    new IndexOptimizedLiftedTaskMockState(ackIndex = Map.empty,
      hbIndex = TreeMap.empty,
      taskStates = Map.empty)
  }
}
