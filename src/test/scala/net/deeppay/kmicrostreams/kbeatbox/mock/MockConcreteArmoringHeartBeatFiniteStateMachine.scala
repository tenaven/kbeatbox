...
import net.deeppay.kmicrostreams.kbeatbox.finitestatemachine.ArmoringHeartBeatFiniteStateMachine
import net.deeppay.kmicrostreams.kbeatbox.stateapi.HeartBeatKeepingStateInterface

class MockConcreteArmoringHeartBeatFiniteStateMachine extends ArmoringHeartBeatFiniteStateMachine {

  override def zero(): HeartBeatKeepingStateInterface = new MockConcreteHeartBeatKeepingFiniteStateMachine().zero()
}
