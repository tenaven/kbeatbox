...
import net.deeppay.kmicrostreams.kbeatbox.finitestatemachine.LiftedTaskStateFiniteStateMachine
import net.deeppay.kmicrostreams.kbeatbox.stateapi.PriorityQueueTaskState

class MockConcreteLiftedTaskStateFiniteStateMachine extends LiftedTaskStateFiniteStateMachine[LiftedTaskMockState] {
  override def zero() = LiftedTaskMockState(Map.empty[String, PriorityQueueTaskState])
