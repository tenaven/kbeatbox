...
import com.tenaven.kbeatbox.kbeatbox.finitestatemachine.LiftedTaskStateFiniteStateMachine
import com.tenaven.kbeatbox.kbeatbox.mock
...
class MockConcreteLiftedTaskStateFiniteStateMachine extends LiftedTaskStateFiniteStateMachine[LiftedTaskMockState] {
  override def zero() = mock.LiftedTaskMockState(Map.empty[String, PriorityQueueTaskState])
