...
\begin{itemize}
 \item \makebox[2.5cm]{Event time\hfill} Real time when the event/data item was created
 \item \makebox[2.5cm]{Ingestion time\hfill} System time when the data item was received
 \item \makebox[2.5cm]{Processing Time\hfill} System time when the data item is processed
\end{itemize}
\end{column}
