...
also presents a canned OpenSource solution that has seen production in reallife to help you out in a similar context.
...
### Naive but seen in reallife code
...
## First problem: don't access system time
...
## Second problem: cut-off time cannot be CONSTANT
